			...
			<div class="container">
				...
				<div class="col-md-4 col-sm-6 no_paddin">
					<a class="" href="/courses/">
						<div class="box">
							...
							<div class="title2">Delphi, Пользователь ПК,<br>Swift</div>
						</div>
					</a>	
				</div>
				<div class="col-md-4 col-sm-6 no_paddin">
				...
				<div class="col-md-4 col-sm-6 no_paddin">
					<a class="" href="/price/">
						<div class="box">
							<div class="icon">
								<img class="" src="/images/icon5.png">
							</div>
							<div class="title1">Цены на услуги</div>
							<div class="title1_mob">Цены на услуги</div>
						</div>
					</a>	
				</div>
				<div class="col-md-4 col-sm-6 no_paddin">
					<a class="" href="/contacts/">
						<div class="box">
							<div class="icon">
								<img class="" src="/images/icon6.png">
							</div>
							<div class="title1">Контакты</div>
							<div class="title1_mob">Контакты</div>
						</div>
					</a>	
				</div>			
			</div>
