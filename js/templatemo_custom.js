...
*/
/*	
	$(".templatemo_homeservice").click(function(){
		$("#menu-container .portfolio").hide();
		$("#menu-container .testimonial").hide();		
		$('#menu-container .portfolio').hide();	
		$('#menu-container .about').hide();
		$('#menu-container .contact').hide();
		$('#menu-container .services').hide();
	...
	$(".templatemo_link").click(function( ){
    $('#menu-container .homepage').fadeOut(500, function(){									  
        $('#menu-container .services').fadeIn(500);
	    });
	return false;
